...
public:
	Ghosts() {
		...
		inky_text.loadFromFile("things.png", IntRect(0, 45, 15, 15));
		...
		clyde_text.loadFromFile("things.png", IntRect(0, 60, 15, 15));
